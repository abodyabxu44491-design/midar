...
| القسم | التفاصيل |
|---|---|
| لوحة المالك | المدارس والاشتراكات، طلبات التجربة، إعدادات المنصة، سجل العمليات |
| إدارة المدرسة | الطلاب، المعلمون، الفصول والمواد، الحضور، الجدول الدراسي، الاختبارات، كشوف الدرجات، الرسوم، الإعلانات، الإعدادات، السجل |
