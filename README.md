...
| الجهاز | الطريقة |
|---|---|
| أندرويد | يظهر زر «تثبيت مِدار» أسفل الشاشة، أو من قائمة المتصفح: «تثبيت التطبيق» |
| آيفون وآيباد | زر المشاركة ثم «إضافة إلى الشاشة الرئيسية» (تظهر رسالة تذكير تلقائيًا) |
| ويندوز وماك | أيقونة التثبيت في شريط العنوان في Chrome أو Edge، أو زر «تثبيت مِدار» |
